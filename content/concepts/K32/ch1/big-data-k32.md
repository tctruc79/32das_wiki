...
Dữ liệu lớn là dữ liệu có quy mô và độ phức tạp vượt quá khả năng lưu
trữ/xử lý của 1 máy đơn lẻ hoặc hệ thống truyền thống, được mô tả qua 5
đặc tính ("5 V's"): Volume, Velocity, Variety, Veracity, Value.
<br><span class="en">Big data is data whose scale and complexity exceed
what a single machine or traditional system can store/process, described
via 5 traits ("the 5 V's"): Volume, Velocity, Variety, Veracity,
Value.</span>
...
- **Key point**: dữ liệu lớn nói về kích thước/độ phức tạp của dữ liệu,
  không nhất thiết nói về chất lượng bằng chứng. Dữ liệu *đúng* thường có
  giá trị hơn dữ liệu *nhiều*.
  <br><span class="en">**Key point**: big data is about the size/
  complexity of data, not necessarily the quality of evidence. The
  *right* data is often more valuable than *more* data.</span>
