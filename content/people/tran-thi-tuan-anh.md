...
- Sách giáo khoa chính: Provost & Fawcett (2013) *Data Science for
  ...
  K32 đều dùng). K32 thêm James, Witten, Hastie, Tibshirani & Taylor
  (2023) *An Introduction to Statistical Learning with Applications in
  Python*.
  <br><span class="en">Main textbooks: Provost & Fawcett (2013) *Data
  Science for Business*; VanderPlas (2016) *Python Data Science Handbook*
  (both K31 and K32 use these). K32 adds James, Witten, Hastie,
