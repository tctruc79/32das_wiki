...
- **Foundational metaphor** (kept from the earlier
  version): "data-analytic thinking provides the compass; data-driven
  decision making provides the movement."
- **5 concrete analytic-thinking steps** (an
...
- **7-condition checklist** for "does this problem
  ...
  exceeds the cost.
- Data-driven culture / data-driven organisation:
