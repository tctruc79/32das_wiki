...
The DIKW framework describes 4 layers of data
transformation: Data → Information → Knowledge → Wisdom, each step
upward requiring a human choice.

## Explanation

- 4 layers: Data → Information → Knowledge → Wisdom
