...
// (public/bi/ va public/en/) ma khong can biet dang build cay nao.
...
// origin (kiem tra bang hostname, khong biet gi ve /bi hay /en la 2 cay build rieng biet)
